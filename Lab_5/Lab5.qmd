...
Проведен анализ набора данных с использованием пакетов dplyr, tidyverse и readr, выполнены поставленные задачи и подготовлен отчет.

## Вывод 

Изучены методы исследования радиоэлектронной обстановки, сформировано представление о функционировании Wi-Fi сетей на канальном и сетевом уровнях модели OSI. Отработаны навыки работы с языком программирования R. Укреплены знания основных функций обработки данных в экосистеме tidyverse.